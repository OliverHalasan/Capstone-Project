...
<script type="text/javascript">
    function pullsearches() {
        ...
        for (var i = 0; i < localStorage.length - 1; i++) {
            ...
            hrefVariable = "../application/search?query=" + jobURL + "&location=" + city + "%2C+" + province + "&type=&date=365&distance=0"
            card = '<a href="' + hrefVariable + '"class="list-group-item list-group-item-action w-75">' + job + ' jobs in ' + city + ' , ' + province + '.</a>';
            if (job == "") {
                //../application/search?query=&location=Edmonton%2C+Alberta&type=&date=365&distance=0
                hrefVariable = "../application/search?query=&location=" + city + "%2C+" + province + "&type=&date=365&distance=0";
            ...
            if (job == "" && province === undefined) {
                hrefVariable = "../application/search?query=&location=" + city + "&type=&date=365&distance=0";
                card = '<a href="' + hrefVariable + '"class="list-group-item list-group-item-action w-75">' + 'Jobs in ' + city + '.</a>';
            }
            if (job != "" && province === undefined) {
                console.log("okok");
                hrefVariable = "../application/search?query=" + jobURL + "&location=" + city + "&type=&date=0&find-jobs=";
